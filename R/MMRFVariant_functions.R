...
#---------------Gets variants from gene list


#' @title MMRFVariant_GetVariantsbyGene
#' @description
...
MMRFVariant_GetVariantsbyGene<- function(variant.ann,ListGene=NULL){
  
  
  
  if(is.null(variant.ann) || is.null(ListGene) ){
    stop("Please provide the file of the annotated variants and/or the ListGene.")
  }
