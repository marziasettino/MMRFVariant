...
<p align="justify">The following plots show the KM survival curves for each variant (i.e. <b>dbSNP ID</b>) in <b>Listvariant</b> with respect to the treatment (i.e. <b>Therapy class</b>).
